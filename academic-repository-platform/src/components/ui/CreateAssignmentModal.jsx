 ...
 * Allows faculty to create new assignments with all necessary details
 */
const CreateAssignmentModal = ({ isOpen, onClose, onCreateAssignment, classroomId }) => {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-100">Fill in the details to create an assignment</p>
              </div>
            </div>
            <button
              onClick={onClose}
